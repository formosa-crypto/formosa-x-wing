...
int main(void)
{
  ...
  jade_kem_xwing_xwing_amd64_avx2_keypair_derand(pk0, sk0, randomness0);
...
//    }
//  }
// This will produce an error, even in formosa-mlkem
  ...
  jade_kem_xwing_xwing_amd64_avx2_enc_derand(ct0, shk0, pk0, randomness1);
